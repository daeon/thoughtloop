...
1. Discover covers different architecture families rather than several variants of one stack.
2. Discover separates hard requirements from inherited design conventions.
3. Decide identifies any decision-sensitive unknown that should be measured before commitment.
